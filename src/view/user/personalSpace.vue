	...
	<div id="personalSpace">
		...
		<el-container style="padding: 0 10%;">
			...
			<el-header style="height: 200px;width: 100%;position: relative;">
				<el-upload class="avatar-uploader" style="float: left;background: white; margin-top: 1rem; margin-left: -1.3rem;"  :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
